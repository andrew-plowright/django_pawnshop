"""
Django settings for localpawnshop project.
...
SECRET_KEY = os.environ.get('DJANGO_PAWNSHOP_SECRET_KEY', '')
...
MIDDLEWARE = [
    ...
    # Custom middleware that I added
...
ROOT_URLCONF = 'localpawnshop.urls'
...
WSGI_APPLICATION = 'localpawnshop.wsgi.application'
